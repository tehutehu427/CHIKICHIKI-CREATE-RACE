...
PostEffectDamage::PostEffectDamage()
{
}
...
void PostEffectDamage::UpdateConstBuffer()
{
	...
	cbBuf->g = Application::SCREEN_SIZE_X;		//画面サイズX
	cbBuf->b = Application::SCREEN_SIZE_Y;		//画面サイズY
